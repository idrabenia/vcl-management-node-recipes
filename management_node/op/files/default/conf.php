...
define("BASEURL", "https://192.168.100.2/vcl");   // no trailing slash - all of the URL except /index.php
define("SCRIPT", "/index.php");                 // this should only be "/index.php" unless you rename index.php to something else
define("HELPURL", "https://192.168.100.2/help/"); // URL pointed to by the "Help" link in the navigation area
define("HELPEMAIL", "drobenyai@tut.by");        // if an unexpected error occurs, users will be prompted that they can email
                                                    //   this address for further assistance
define("ERROREMAIL", "drobenyai@tut.by");      // if an unexpected error occurs, the code will send an email about it to
                                                    //   to this address
define("ENVELOPESENDER", "drobenyai@tut.by");   // email address for envelope sender of mail messages
                                                     //   if a message gets bounced, it goes to this address
define("COOKIEDOMAIN", "192.168.100.2");       // domain in which cookies are set
define("HOMEURL", "http://192.168.100.2/"); // url to go to when someone clicks HOME or Logout
